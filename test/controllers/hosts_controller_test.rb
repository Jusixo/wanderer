...
class HostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create host" do
    assert_difference('Host.count') do
      post hosts_url, params: { host: { market_info: @host.market_info, name: @host.name, web_link: @host.web_link } }
    end
  ...
  test "should update host" do
    patch host_url(@host), params: { host: { market_info: @host.market_info, name: @host.name, web_link: @host.web_link } }
